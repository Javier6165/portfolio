...
- `docs/PLAN-11-LIVE-WIP-SPOTLIGHT.md`: next proposed Home iteration: base UI/content redesign first, then explicit WIP/final states, Follow mode and implementation gates.
